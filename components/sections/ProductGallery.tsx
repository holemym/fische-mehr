...
const DIMS: Record<string, [number, number]> = {
  ...
  'shoot-smoked-fish-row': [1196, 1800],
  'shoot-honey-jar': [1196, 1800],
  'shoot-salmon-fillet': [1196, 1800],
  'shoot-tinned-fish': [1196, 1800],
  'shoot-seashells': [1800, 1196],
  'shoot-salmon-slices': [1196, 1800],
  'shoot-smoked-counter': [1196, 1800],
  'shoot-owner-fish-1': [1196, 1800],
  'shoot-owner-fish-2': [1196, 1800],
  'shoot-frozen-fish-1': [1196, 1800],
  'shoot-frozen-fish-2': [1196, 1800],
