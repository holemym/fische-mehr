...
/**
 * Real Austrian legal text (German is the binding version). ⟦…⟧ marks facts the
 * shop owner must supply. Not legal advice — have it reviewed before launch.
 */
...
export function Impressum() {
  return (
    <div className="max-w-prose">
      ...
      <P>
        <strong>⟦Firmenwortlaut / Inhaber⟧</strong>
        <br />
        Fischhandlung — Einzelhandel mit Fisch und Lebensmitteln
        <br />
        {SITE.streetAddress} ⟦Hausnummer⟧, {SITE.postalCode} {SITE.city}, Österreich
      </P>
      <P>
      ...
      <P>
        Umsatzsteuer-Identifikationsnummer (UID): ⟦ATU00000000⟧
        <br />
  ...
  return (
    <div className="max-w-prose">
      ...
      <P>
        ...
        <br />
        <strong>⟦Firmenwortlaut / Inhaber⟧</strong>, {SITE.streetAddress} ⟦Hausnummer⟧,{' '}
        {SITE.postalCode} {SITE.city}, Österreich. E-Mail: ⟦shop@…⟧.
      </P>
      ...
      <P>
        ...
        Zukunft widerrufen können — etwa per E-Mail an ⟦shop@…⟧.
      </P>
      ...
      <P>
        <span className="mt-8 inline-block rounded-sm border border-dashed border-coral/50 bg-coral/5 px-4 py-2.5 font-mono text-xs text-grey-dark">
          ⟦Von einem Rechtsbeistand prüfen lassen und die Platzhalter ausfüllen, bevor die
          Seite live geht.⟧
        </span>
      </P>
    </div>
